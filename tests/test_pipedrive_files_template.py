...
def test_escolhe_por_prefixo_contrato_padrao():
    arquivos = [
        {"id": 1, "file_type": "docx", "name": "x-contrato_padrao.docx", "update_time": "2026-05-01 10:00:00"},
        {"id": 2, "file_type": "docx", "name": "contrato_padrao - Copia.docx", "update_time": "2026-05-02 10:00:00"},
...
def test_escolhe_mais_recente_quando_multiplos_prefixos():
    arquivos = [
        {"id": 10, "file_type": "docx", "name": "contrato_padrao.docx", "update_time": "2026-05-01 10:00:00"},
        {"id": 11, "file_type": "docx", "name": "Contrato_Padrao2.docx", "update_time": "2026-05-03 10:00:00"},
        {"id": 12, "file_type": "docx", "name": "contrato_padrao - Copia.docx", "update_time": "2026-05-02 10:00:00"},
    ]
    escolhido = escolher_docx_contrato_padrao(arquivos)
    assert escolhido is not None
