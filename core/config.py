...
# Microsoft Graph (OAuth2) — chaves do .env (igual Automação CCEE)
GRAPH_TENANT_ID = _env("tenant_id")
...
PLUNE_TIPO_CONTRATO_IMPLANTACAO_ID = G.PLUNE_TIPO_CONTRATO_IMPLANTACAO_ID
PLUNE_TIPO_CONTRATO_USINA_RECORRENTE_ID = G.PLUNE_TIPO_CONTRATO_USINA_RECORRENTE_ID
PLUNE_TIPO_CONTRATO_QUALIDADE_RECORRENTE_ID = G.PLUNE_TIPO_CONTRATO_QUALIDADE_RECORRENTE_ID
PLUNE_TIPO_CONTRATO_MERCADO_LIVRE_RECORRENTE_ID = G.PLUNE_TIPO_CONTRATO_MERCADO_LIVRE_RECORRENTE_ID
PLUNE_TIPO_CONTRATO_SOLE_RECORRENTE_ID = G.PLUNE_TIPO_CONTRATO_SOLE_RECORRENTE_ID
...
PLUNE_PEDIDO_SERIE = G.PLUNE_PEDIDO_SERIE
PLUNE_PEDIDO_MODELO_ID = G.PLUNE_PEDIDO_MODELO_ID
PLUNE_COMISSAO_MESES_ANUAL = G.PLUNE_COMISSAO_MESES_ANUAL
...
CORTE_TEMPORAL_GRACE_MINUTOS = G.CORTE_TEMPORAL_GRACE_MINUTOS
